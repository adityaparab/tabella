...
**Status:** 🚧 Cycle 3 of 7 complete — the differentiator is banked: Claude operates the live
dataset via MCP. See [docs/PRD.md](docs/PRD.md) and the [CHANGELOG](CHANGELOG.md).
